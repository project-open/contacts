...
set title "[_ contacts.Add_to_List]"
...
append form_elements {
    {list_ids:text(checkbox),multiple {label "[_ contacts.Add_to_Lists]"} {options $list_options}}
}
set edit_buttons [list [list "[_ contacts.lt_Add_to_Selected_Lists]" create]]
