...
<table width="100%">
  ...
  <tr>
    <td valign="top" width="50%" style="padding: 1em; background-color: #CCF;"> 
      ...
      <include src="/packages/contacts/lib/searches" party_id="@party_id@" />
      <include src="/packages/contacts/lib/history" party_id="@party_id@" truncate_len="380" limit="5" hide_form_p="t" />
    </td>
    <td valign="top" width="50%" style="padding: 1em; background-color: #FCC;"> 
      ...
      <include src="/packages/contacts/lib/contact-attributes" party_id="@merge_party_id@" />
      <include src="/packages/contacts/lib/contact-relationships" party_id="@merge_party_id@" />
      <include src="/packages/contacts/lib/searches" party_id="@merge_party_id@" />
      <include src="/packages/contacts/lib/history" party_id="@merge_party_id@" truncate_len="380" limit="5" hide_form_p="t" />
    </td>
  </tr>
</table>
