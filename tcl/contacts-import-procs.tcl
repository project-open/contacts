...
ad_proc -public contacts::import::csv {
    ...
    - The mapping of the Elements from the CSV file id hard coded at the moment and not really internationalized. Here someone should replace the "E-Mail" and "Firma" with "[_ contacts.csv_email]" and "[_ contacts.csv_name]"
