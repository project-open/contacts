...
ad_proc -public contact::oo::import_oo_pdf {
    ...
    <br>
    Since 2006/11/08 first tries contact::oo::import_oo_pdf_using_remote_cognovis_converter.<br>
...
ad_proc -public contact::oo::convert_to_pdf_file_using_remote_cognovis_converter {
    ...
    and saves the result to a file named as specified in destination_file.<br>
    <br>
    Returns 0 (FALSE) on an error and 1 (TRUE) on success.<br>
