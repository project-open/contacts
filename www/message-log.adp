...
<html>
<head>
<title>#contacts.Print_Letter#</title>
<link rel="stylesheet" type="text/css" href="/resources/contacts/contacts-print.css">
</head>
<body>
<p style="padding: 2em;"><a href="@return_url@" style="padding: 2px; text-decoration: none; background-color: #EEE; border: 1px solid #CCC;">#contacts.Return_to_history#</a></p>
