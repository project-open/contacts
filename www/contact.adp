...
<div id="contact-info">
  ...
  <div class="secondary">
    ...
    <include
      src="/packages/contacts/lib/history-portlet"
      party_id="@party_id@"
      limit="3"
      truncate_len="100"
      size="small"
      ...
      <br />
    <if @pm_package_id@>
      <include src="/packages/contacts/lib/projects-portlet"
	...
	<include src="/packages/contacts/lib/glossar-list-portlet" 
		owner_id=@party_id@ 
		orderby=@orderby@ 
		customer_id=@party_id@ 
		format=table />
	...
	<include src="/packages/contacts/lib/customer-group-portlet" 
	    customer_id=@party_id@
	...
	<br />
        ...
        <include src="/packages/contacts/lib/pm-tasks-portlet"
		display_mode="list"
